...
public class AVLTree < E
  ...
  public AVLTree(BinaryTree<E> tree){
        int left=heightForLeftTree(tree,tree.root,0);
        int right=heightForRightTree(tree,tree.root,0);
        int balance;
        balance=right-left;
        ...
        if(balance<2){
          ...
          System.out.println("This Tree is not an AVL tree");
        }

  }

  private int heightForLeftTree(BinaryTree<E> btree,Node<E> root,int height){
    if(root.left==null){
      return height;
    }
    else{
      return heightForLeftTree(btree, root.left,height+1);
    }

  }

  private int heightForRightTree(BinaryTree<E> btree,Node<E> root,int height){
    if(root.right==null){
      return height;
    }
    else{
      return heightForRightTree(btree, root.right,height+1);
    }
